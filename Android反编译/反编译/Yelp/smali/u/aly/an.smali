...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lu/aly/an;->l:Lu/aly/an;
...
.method private constructor <init>(Landroid/content/Context;Lu/aly/ab;)V
    ...
    .line 15
    iput-wide v6, p0, Lu/aly/an;->a:J

    .line 16
    const-wide/32 v0, 0x7b98a00

    iput-wide v0, p0, Lu/aly/an;->b:J

    .line 17
    const v0, 0x1b7740

    iput v0, p0, Lu/aly/an;->c:I

    .line 18
    iput v2, p0, Lu/aly/an;->d:I

    .line 23
    iput-wide v6, p0, Lu/aly/an;->g:J
    ...
    iput-object v0, p0, Lu/aly/an;->e:Lcom/umeng/analytics/h;
...
.method public static declared-synchronized a(Landroid/content/Context;Lu/aly/ab;)Lu/aly/an;
    ...
    .prologue
    .line 33
    const-class v1, Lu/aly/an;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lu/aly/an;->l:Lu/aly/an;
    ...
    invoke-direct {v0, p0, p1}, Lu/aly/an;-><init>(Landroid/content/Context;Lu/aly/ab;)V
    ...
    invoke-virtual {v0, v2}, Lu/aly/an;->a(Lu/aly/g$a;)V
...
.method public a()Z
    ...
    .line 52
    iget-object v2, p0, Lu/aly/an;->e:Lcom/umeng/analytics/h;
    ...
    .line 56
    :cond_1
    iget-object v2, p0, Lu/aly/an;->f:Lu/aly/ab;

    invoke-virtual {v2}, Lu/aly/ab;->f()Z
    ...
    iget-object v4, p0, Lu/aly/an;->f:Lu/aly/ab;

    invoke-virtual {v4}, Lu/aly/ab;->o()J
    ...
    .line 62
    iget-object v0, p0, Lu/aly/an;->k:Landroid/content/Context;
